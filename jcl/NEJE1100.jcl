//NEJ${ENT}1100 JOB (ACCOUNT),'NEJ${ENT}1100',
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
  DEL ${HLQ}.BAT1SBAS.NEJ${ENT}1100.STP0001.EMPDEPT0
  DEL ${HLQ}.BAT1SBAS.NEJ${ENT}1100.STP0001.INCIDENT
  SET MAXCC = 0
//*
//***********************************************************
//*       PROGRAMA NE4C1100 GENERA INTERFAZ NEEC1100        *
//***********************************************************
//STP0001 EXEC PGM=IKJEFT01
//E1DQENT0 DD DSN=${HLQ}.BAT1SBAS.NEJ${ENT}1000.STP0003.SORTFB,DISP=SHR
//S1DQSAL0 DD DSN=${HLQ}.BAT1SBAS.NEJ${ENT}1100.STP0001.EMPDEPT0,
